...
| Script Name | Output |
|--------------|------------|
| <span style="color: red;"> *training_main.py*</span> | <span style="color: red;">**loads the data from the MEASTRO dataset as a Pytorch dataset, launches the model (defined in model.py script) training phase and saves the model in the ./data folder (model.pth)**</span>|
